using System.IO;
using MatchBeth.NHibernateProvider;
using NHibernate;
using NHibernate.Cfg;
using NHibernate.Tool.hbm2ddl;
using NUnit.Framework;

namespace MatchBeth.Tests.NHibernateProvider
{
    /// <summary>
    ...
    public class MappingIntegrationTests
    {
        ...
        public void CanGenerateDatabaseSchema() {
            using (ISession session = _sessionFactory.OpenSession()) {
                using (TextWriter stringWriter = new StreamWriter("../../../../app/MatchBeth.DB/Schema/UnitTestGeneratedSchema.sql")) {
